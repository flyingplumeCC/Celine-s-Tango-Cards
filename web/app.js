...
async function loadLibraries() {
  const travelWords = window.travelWords || await loadCommonJsData('../data/words.js')
  const businessWords = window.businessWords || await loadCommonJsData('../data/businessWords.js')
  const customWords = window.customWords || await loadCommonJsData('../data/customWords.js')
